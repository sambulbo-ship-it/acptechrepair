...
const MachineDetail = () => {
  ...
  const { getMachine, getEntriesForMachine, addEntry, deleteEntry, deleteMachine, updateMachine, team, addTeamMember, updateTeamMember, removeTeamMember, addMachine, machines, loading: machinesLoading } = useCloudData();
